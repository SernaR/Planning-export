 ...
 */
final class Version20200717083743 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO transport_order (id, carrier_id, first_loading_warehouse_id, vehicle_id, first_delivery_warehouse_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, created_at, updated_at, weight, volume, invoice, comment, is_cancelled) SELECT id, carrier_id, first_loading_warehouse_id, vehicle_id, first_delivery_warehouse_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, created_at, updated_at, weight, volume, invoice, comment, is_cancelled FROM __temp__transport_order');
