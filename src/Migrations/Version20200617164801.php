 ...
 */
final class Version20200617164801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE initial_params (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__country AS SELECT id, name, code FROM country');
        ...
        $this->addSql('INSERT INTO country (id, name, code) SELECT id, name, code FROM __temp__country');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__vehicle AS SELECT id, name FROM vehicle');
        ...
        $this->addSql('INSERT INTO vehicle (id, name) SELECT id, name FROM __temp__vehicle');
