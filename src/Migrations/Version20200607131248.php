 ...
 */
final class Version20200607131248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO transport_order (id, carrier_id, first_loading_warehouse_id, vehicle_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, weight, volume) SELECT id, carrier_id, first_loading_warehouse_id, vehicle_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, weight, volume FROM __temp__transport_order');
