 ...
 */
final class Version20200617170208 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_780EF2EF92F3E70');
        $this->addSql('DROP INDEX IDX_780EF2E21DFC797');
        $this->addSql('CREATE TEMPORARY TABLE __temp__carrier_country AS SELECT carrier_id, country_id FROM carrier_country');
        $this->addSql('DROP TABLE carrier_country');
        $this->addSql('CREATE TABLE carrier_country (carrier_id INTEGER NOT NULL, country_id INTEGER NOT NULL, PRIMARY KEY(carrier_id, country_id), CONSTRAINT FK_780EF2E21DFC797 FOREIGN KEY (carrier_id) REFERENCES carrier (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_780EF2EF92F3E70 FOREIGN KEY (country_id) REFERENCES country (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO carrier_country (carrier_id, country_id) SELECT carrier_id, country_id FROM __temp__carrier_country');
        $this->addSql('DROP TABLE __temp__carrier_country');
        $this->addSql('CREATE INDEX IDX_780EF2EF92F3E70 ON carrier_country (country_id)');
        $this->addSql('CREATE INDEX IDX_780EF2E21DFC797 ON carrier_country (carrier_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__warehouse AS SELECT id, adress_id, initial_params_id, name FROM warehouse');
        $this->addSql('DROP TABLE warehouse');
        $this->addSql('CREATE TABLE warehouse (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, adress_id INTEGER DEFAULT NULL, initial_params_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_ECB38BFC8486F9AC FOREIGN KEY (adress_id) REFERENCES adress (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_ECB38BFCF825C0DA FOREIGN KEY (initial_params_id) REFERENCES initial_params (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO warehouse (id, adress_id, initial_params_id, name) SELECT id, adress_id, initial_params_id, name FROM __temp__warehouse');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__carrier_country AS SELECT carrier_id, country_id FROM carrier_country');
        $this->addSql('DROP TABLE carrier_country');
        $this->addSql('CREATE TABLE carrier_country (carrier_id INTEGER NOT NULL, country_id INTEGER NOT NULL, PRIMARY KEY(carrier_id, country_id))');
        $this->addSql('INSERT INTO carrier_country (carrier_id, country_id) SELECT carrier_id, country_id FROM __temp__carrier_country');
        $this->addSql('DROP TABLE __temp__carrier_country');
        $this->addSql('CREATE INDEX IDX_780EF2E21DFC797 ON carrier_country (carrier_id)');
        $this->addSql('CREATE INDEX IDX_780EF2EF92F3E70 ON carrier_country (country_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__warehouse AS SELECT id, adress_id, initial_params_id, name FROM warehouse');
        $this->addSql('DROP TABLE warehouse');
        $this->addSql('CREATE TABLE warehouse (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, adress_id INTEGER DEFAULT NULL, initial_params_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO warehouse (id, adress_id, initial_params_id, name) SELECT id, adress_id, initial_params_id, name FROM __temp__warehouse');
        $this->addSql('DROP TABLE __temp__warehouse');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_ECB38BFC8486F9AC ON warehouse (adress_id)');
        $this->addSql('CREATE INDEX IDX_ECB38BFCF825C0DA ON warehouse (initial_params_id)');
