 ...
 */
final class Version20200730184359 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE destination_params (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, country_id INTEGER DEFAULT NULL, initial_params_id INTEGER DEFAULT NULL, CONSTRAINT FK_DDF79164F92F3E70 FOREIGN KEY (country_id) REFERENCES country (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DDF79164F825C0DA FOREIGN KEY (initial_params_id) REFERENCES initial_params (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_DDF79164F825C0DA ON destination_params (initial_params_id)');
        ...
        $this->addSql('DROP INDEX IDX_DFEC3F39FDB3798');
        $this->addSql('DROP INDEX IDX_DFEC3F3916068855');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__rate AS SELECT id, first_loading_warehouse_id, first_delivery_warehouse_id, carrier_id, second_loading_warehouse_id, second_delivery_warehouse_id, amount FROM rate');
        $this->addSql('DROP TABLE rate');
        $this->addSql('CREATE TABLE rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_loading_warehouse_id INTEGER DEFAULT NULL, first_delivery_warehouse_id INTEGER DEFAULT NULL, carrier_id INTEGER DEFAULT NULL, second_loading_warehouse_id INTEGER DEFAULT NULL, second_delivery_warehouse_id INTEGER DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, CONSTRAINT FK_DFEC3F3968563B78 FOREIGN KEY (first_loading_warehouse_id) REFERENCES warehouse (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DFEC3F394A7A3B5E FOREIGN KEY (first_delivery_warehouse_id) REFERENCES warehouse (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DFEC3F3921DFC797 FOREIGN KEY (carrier_id) REFERENCES carrier (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DFEC3F3916068855 FOREIGN KEY (second_loading_warehouse_id) REFERENCES warehouse (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DFEC3F39FDB3798 FOREIGN KEY (second_delivery_warehouse_id) REFERENCES warehouse (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO rate (id, first_loading_warehouse_id, first_delivery_warehouse_id, carrier_id, second_loading_warehouse_id, second_delivery_warehouse_id, amount) SELECT id, first_loading_warehouse_id, first_delivery_warehouse_id, carrier_id, second_loading_warehouse_id, second_delivery_warehouse_id, amount FROM __temp__rate');
        $this->addSql('DROP TABLE __temp__rate');
        $this->addSql('CREATE INDEX IDX_DFEC3F39FDB3798 ON rate (second_delivery_warehouse_id)');
        $this->addSql('CREATE INDEX IDX_DFEC3F3916068855 ON rate (second_loading_warehouse_id)');
        ...
        $this->addSql('DROP INDEX IDX_6826346016068855');
        $this->addSql('DROP INDEX IDX_68263460FDB3798');
        $this->addSql('CREATE TEMPORARY TABLE __temp__transport_order AS SELECT id, carrier_id, first_loading_warehouse_id, vehicle_id, first_delivery_warehouse_id, second_loading_warehouse_id, second_delivery_warehouse_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, created_at, updated_at, weight, invoice, comment, volume, is_cancelled, second_loading_start, effective_second_loading_start, second_loading_end, effective_second_loading_end, second_delivery, effective_second_delivery FROM transport_order');
        $this->addSql('DROP TABLE transport_order');
        $this->addSql('CREATE TABLE transport_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, carrier_id INTEGER DEFAULT NULL, first_loading_warehouse_id INTEGER DEFAULT NULL, vehicle_id INTEGER DEFAULT NULL, first_delivery_warehouse_id INTEGER DEFAULT NULL, second_loading_warehouse_id INTEGER DEFAULT NULL, second_delivery_warehouse_id INTEGER DEFAULT NULL, code VARCHAR(255) NOT NULL COLLATE BINARY, first_loading_start DATETIME NOT NULL, first_loading_end DATETIME NOT NULL, first_delivery DATETIME NOT NULL, amount DOUBLE PRECISION DEFAULT NULL, effective_first_loading_start DATETIME DEFAULT NULL, effective_first_loading_end DATETIME DEFAULT NULL, effective_first_loading_boxes INTEGER DEFAULT NULL, effective_first_loading_pallets INTEGER DEFAULT NULL, effective_first_loading_pieces INTEGER DEFAULT NULL, effective_first_delivery DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, weight INTEGER DEFAULT NULL, invoice VARCHAR(255) DEFAULT NULL COLLATE BINARY, comment CLOB DEFAULT NULL COLLATE BINARY, volume DOUBLE PRECISION DEFAULT NULL, is_cancelled BOOLEAN DEFAULT NULL, second_loading_start DATETIME DEFAULT NULL, effective_second_loading_start DATETIME DEFAULT NULL, second_loading_end DATETIME DEFAULT NULL, effective_second_loading_end DATETIME DEFAULT NULL, second_delivery DATETIME DEFAULT NULL, effective_second_delivery DATETIME DEFAULT NULL, CONSTRAINT FK_6826346021DFC797 FOREIGN KEY (carrier_id) REFERENCES carrier (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6826346068563B78 FOREIGN KEY (first_loading_warehouse_id) REFERENCES warehouse (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_68263460545317D1 FOREIGN KEY (vehicle_id) REFERENCES vehicle (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_682634604A7A3B5E FOREIGN KEY (first_delivery_warehouse_id) REFERENCES warehouse (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6826346016068855 FOREIGN KEY (second_loading_warehouse_id) REFERENCES warehouse (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_68263460FDB3798 FOREIGN KEY (second_delivery_warehouse_id) REFERENCES warehouse (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO transport_order (id, carrier_id, first_loading_warehouse_id, vehicle_id, first_delivery_warehouse_id, second_loading_warehouse_id, second_delivery_warehouse_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, created_at, updated_at, weight, invoice, comment, volume, is_cancelled, second_loading_start, effective_second_loading_start, second_loading_end, effective_second_loading_end, second_delivery, effective_second_delivery) SELECT id, carrier_id, first_loading_warehouse_id, vehicle_id, first_delivery_warehouse_id, second_loading_warehouse_id, second_delivery_warehouse_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, created_at, updated_at, weight, invoice, comment, volume, is_cancelled, second_loading_start, effective_second_loading_start, second_loading_end, effective_second_loading_end, second_delivery, effective_second_delivery FROM __temp__transport_order');
        ...
        $this->addSql('CREATE INDEX IDX_6826346016068855 ON transport_order (second_loading_warehouse_id)');
        $this->addSql('CREATE INDEX IDX_68263460FDB3798 ON transport_order (second_delivery_warehouse_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_5373C966F825C0DA ON country (initial_params_id)');
        $this->addSql('DROP INDEX UNIQ_DDF79164F92F3E70');
        $this->addSql('DROP INDEX IDX_DDF79164F825C0DA');
        $this->addSql('CREATE TEMPORARY TABLE __temp__destination_params AS SELECT id, country_id FROM destination_params');
        $this->addSql('DROP TABLE destination_params');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__rate AS SELECT id, first_loading_warehouse_id, first_delivery_warehouse_id, carrier_id, second_loading_warehouse_id, second_delivery_warehouse_id, amount FROM rate');
        $this->addSql('DROP TABLE rate');
        $this->addSql('CREATE TABLE rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_loading_warehouse_id INTEGER DEFAULT NULL, first_delivery_warehouse_id INTEGER DEFAULT NULL, carrier_id INTEGER DEFAULT NULL, second_loading_warehouse_id INTEGER DEFAULT NULL, second_delivery_warehouse_id INTEGER DEFAULT NULL, amount DOUBLE PRECISION NOT NULL)');
        $this->addSql('INSERT INTO rate (id, first_loading_warehouse_id, first_delivery_warehouse_id, carrier_id, second_loading_warehouse_id, second_delivery_warehouse_id, amount) SELECT id, first_loading_warehouse_id, first_delivery_warehouse_id, carrier_id, second_loading_warehouse_id, second_delivery_warehouse_id, amount FROM __temp__rate');
        $this->addSql('DROP TABLE __temp__rate');
        $this->addSql('CREATE INDEX IDX_DFEC3F3968563B78 ON rate (first_loading_warehouse_id)');
        $this->addSql('CREATE INDEX IDX_DFEC3F394A7A3B5E ON rate (first_delivery_warehouse_id)');
        ...
        $this->addSql('DROP INDEX IDX_6826346016068855');
        $this->addSql('DROP INDEX IDX_68263460FDB3798');
        $this->addSql('CREATE TEMPORARY TABLE __temp__transport_order AS SELECT id, carrier_id, first_loading_warehouse_id, vehicle_id, first_delivery_warehouse_id, second_loading_warehouse_id, second_delivery_warehouse_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, weight, volume, created_at, updated_at, invoice, comment, is_cancelled, second_loading_start, effective_second_loading_start, second_loading_end, effective_second_loading_end, second_delivery, effective_second_delivery FROM transport_order');
        $this->addSql('DROP TABLE transport_order');
        $this->addSql('CREATE TABLE transport_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, carrier_id INTEGER DEFAULT NULL, first_loading_warehouse_id INTEGER DEFAULT NULL, vehicle_id INTEGER DEFAULT NULL, first_delivery_warehouse_id INTEGER DEFAULT NULL, second_loading_warehouse_id INTEGER DEFAULT NULL, second_delivery_warehouse_id INTEGER DEFAULT NULL, code VARCHAR(255) NOT NULL, first_loading_start DATETIME NOT NULL, first_loading_end DATETIME NOT NULL, first_delivery DATETIME NOT NULL, amount DOUBLE PRECISION DEFAULT NULL, effective_first_loading_start DATETIME DEFAULT NULL, effective_first_loading_end DATETIME DEFAULT NULL, effective_first_loading_boxes INTEGER DEFAULT NULL, effective_first_loading_pallets INTEGER DEFAULT NULL, effective_first_loading_pieces INTEGER DEFAULT NULL, effective_first_delivery DATETIME DEFAULT NULL, weight INTEGER DEFAULT NULL, volume DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, invoice VARCHAR(255) DEFAULT NULL, comment CLOB DEFAULT NULL, is_cancelled BOOLEAN DEFAULT NULL, second_loading_start DATETIME DEFAULT NULL, effective_second_loading_start DATETIME DEFAULT NULL, second_loading_end DATETIME DEFAULT NULL, effective_second_loading_end DATETIME DEFAULT NULL, second_delivery DATETIME DEFAULT NULL, effective_second_delivery DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO transport_order (id, carrier_id, first_loading_warehouse_id, vehicle_id, first_delivery_warehouse_id, second_loading_warehouse_id, second_delivery_warehouse_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, weight, volume, created_at, updated_at, invoice, comment, is_cancelled, second_loading_start, effective_second_loading_start, second_loading_end, effective_second_loading_end, second_delivery, effective_second_delivery) SELECT id, carrier_id, first_loading_warehouse_id, vehicle_id, first_delivery_warehouse_id, second_loading_warehouse_id, second_delivery_warehouse_id, code, first_loading_start, first_loading_end, first_delivery, amount, effective_first_loading_start, effective_first_loading_end, effective_first_loading_boxes, effective_first_loading_pallets, effective_first_loading_pieces, effective_first_delivery, weight, volume, created_at, updated_at, invoice, comment, is_cancelled, second_loading_start, effective_second_loading_start, second_loading_end, effective_second_loading_end, second_delivery, effective_second_delivery FROM __temp__transport_order');
        $this->addSql('DROP TABLE __temp__transport_order');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6826346077153098 ON transport_order (code)');
        $this->addSql('CREATE INDEX IDX_6826346021DFC797 ON transport_order (carrier_id)');
